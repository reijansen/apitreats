        ...
        <div class="rounded-2xl border border-slate-200 bg-white/90 p-8 shadow-lg backdrop-blur-sm">
            ...
            {:else if !canReset}
                ...
                <div class="text-center">
                    ...
                    <a
                        href="/officer/forgot"
                        class="mt-6 inline-flex h-10 items-center justify-center rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 px-6 text-sm font-semibold text-white shadow-md transition no-underline hover:shadow-lg hover:from-green-700 hover:to-emerald-700"
                    >
                        Request New Link
                    </a>
                </div>
